...
interface Bank {
	...
	void deposit(float amt); // By default method defined within interfaces are abstract i.e. abstract void deposit(float amt)
	void withdraw(float amt); // By default method defined within interfaces are abstract i.e. abstract void withdraw(float amt)
