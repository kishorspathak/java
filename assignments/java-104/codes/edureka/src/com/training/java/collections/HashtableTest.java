...
/**
 * Hashtable is legacy map implementation and is based on JDK1.2 
 */
public class HashtableTest {
	...
	public static void main(String[] args) {
		...
		// Order of elements is not maintained and only hashing is applied. To retain the order of insertion use LinkedHashMap<>()
		System.out.println(bank);
		
		// In a Hashtable both key and value cannot be null
		bank.put(null, null); //java.lang.NullPointerException
